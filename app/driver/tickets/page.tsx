      ...
      {pageLoading ? (
        ...
        <Card style={{ borderColor: 'var(--card-border)', backgroundColor: 'var(--card-bg)' }}>
          <CardContent className="pt-6">
            {tickets.map((t) => (
              <div key={t.id} className="flex cursor-pointer items-center justify-between border-b py-3 hover:opacity-80" onClick={() => router.push(`/driver/tickets/${t.id}`)} style={{ borderBottomColor: 'var(--card-border)', color: 'var(--text-primary)' }}>
