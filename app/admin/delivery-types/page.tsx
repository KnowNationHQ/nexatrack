...
export default function DeliveryTypesPage() {
  ...
  const load = () => db<any[]>("delivery_types", "select", { order: { column: "created_at", ascending: false } }).then((d) => { if (d) setItems(d) })
  useEffect(() => { load() }, [])
  ...
  return (
    <div>
      <div className="mb-6 flex items-center justify-between">
        <h1 className="text-2xl font-bold text-white">Delivery Types</h1>
