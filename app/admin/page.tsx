...
import { Package, Truck, CheckCircle, DollarSign, Users, ClipboardList, AlertTriangle, ArrowUpRight } from "lucide-react"

const cardStyle = [
  { icon: Package, label: "Total Shipments", color: "from-blue-500 to-blue-600", bg: "bg-blue-500/10" },
  { icon: AlertTriangle, label: "Pending", color: "from-yellow-500 to-yellow-600", bg: "bg-yellow-500/10" },
  { icon: Truck, label: "In Transit", color: "from-orange-500 to-orange-600", bg: "bg-orange-500/10" },
  { icon: CheckCircle, label: "Delivered", color: "from-green-500 to-green-600", bg: "bg-green-500/10" },
  { icon: DollarSign, label: "Revenue", color: "from-emerald-500 to-emerald-600", bg: "bg-emerald-500/10", isCurrency: true },
  { icon: Users, label: "Merchants", color: "from-purple-500 to-purple-600", bg: "bg-purple-500/10" },
  { icon: ClipboardList, label: "Pickups", color: "from-cyan-500 to-cyan-600", bg: "bg-cyan-500/10" },
  { icon: AlertTriangle, label: "Open Tickets", color: "from-red-500 to-red-600", bg: "bg-red-500/10" },
]
    ...
    <div>
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        {cardStyle.map((card, i) => {
          ...
          return (
            <Card key={card.label} className="group relative overflow-hidden border-[#1a1725]/60 bg-gradient-to-b from-[#0a0715] to-[#0d0a1a] shadow-lg shadow-black/20 transition-all duration-300 hover:border-[#FF3E41]/20 hover:shadow-[#FF3E41]/5">
